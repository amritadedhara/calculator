...
var Calculator  = {
   ...
   options:{
    ...
    this.element.addClass(op.theme);
         ...
         //creating history field as a 'div' container on the top,also adding class 'history'
         this.element.append(showHistory) ;
         //appending 'showhistory' to the calculator body
         this.historyPanel = showHistory;
         //passing 'showhistory' with the global variable 'historypanel '
        this.element.append(textfield);
        //appending 'textfield' i.e the display area to the calculator body.
        this.resultField=textfield;
         //passing 'textfield' with the global variable 'resultField '
         var specialGrp = $(document.createElement("section")).addClass('addition');
         //creating an html 'section' and adding class 'addition' in the variable 'specialGrp'
         this.element.append(specialGrp);
         //appending 'specialGrp' section to the calculator body
         var specialButtons = ['MC','MR','MS','M+','M-','CE','+/-','ROOT','%','1/X'];
         //creating an array named 'specialButtons' & added some special buttons of calculator
        ...
        //rendering all the buttons one by one in 'specialButtons' array & along with the class name 'addition'
        //and section name 'specialGrp' also attaching an event listener '_handleOperatorClick1'
         }
        var numberGrp = $(document.createElement("section")).addClass('numbers');
        //creating a html section for calculator number keys & adding class 'numbers'
        this.element.append(numberGrp);
        //appending 'numberGrp' to the calculator body
